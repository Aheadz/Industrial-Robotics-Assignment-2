...
% end
%%   
tbl = PlaceObject('BinL.ply',[0,-0.6,0.2]);
...
%     ; deg2rad([169,-111,-72]) ...
%     ; qF];
% qTraj = InterpolateWaypointRadians(qWaypoints,deg2rad(5));
% if IsCollision(R,model,qTraj,faces,vertex,faceNormals)
%     error('Collision detected!!');
% else
%     display('No collision found');
% end
% R.model.animate(qTraj);
%%  
% checkCollision(update_ellipsoid,tbl.qlim,'SkippedSelfCollisions','parent')
